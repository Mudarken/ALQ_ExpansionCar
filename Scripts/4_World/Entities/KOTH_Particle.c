...
class KOTH_Particle extends House
{
	...
	void KOTH_Particle()
	{
		...
		SetParticleSmokeStart(ParticleList.GRENADE_M18_YELLOW_LOOP); //! no effect on base
		SetParticleSmokeLoop(ParticleList.GRENADE_M18_WHITE_LOOP); //! no effect on base
		SetParticleSmokeWin(ParticleList.GRENADE_M18_GREEN_LOOP); //! no effect on base
		SetParticleSmokeFail(ParticleList.GRENADE_M18_RED_LOOP); //! no effect on base
